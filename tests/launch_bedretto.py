...
data_path = '/home/emanuele/data/emanuele/loki-das/bedretto/m05/hybrid'
output_path = '/home/emanuele/data/emanuele/loki-das/bedretto/output_m05_hybrid'
hdr_filename = 'header_long_bedretto.hdr'
geometry_filename_fiber = 'DAS_geom.txt'
geometry_filename_stat = 'hybrid_geom.dat'
inputs = {}
inputs['tshortp_min_sta'] = 0.003 #0.1
inputs['tshortp_max_sta'] = 0.006 #0.2
inputs['tshorts_min_sta'] = 0.003 #0.15
inputs['tshorts_max_sta'] = 0.006 #0.25
inputs['tshortp_min_fiber'] = 0.003 #0.1
inputs['tshortp_max_fiber'] = 0.006#0.3
inputs['tshorts_min_fiber'] = 0.003#0.15
inputs['tshorts_max_fiber'] = 0.006 #0.35
inputs['slrat'] = 2
inputs['npr'] = 36
inputs['ntrial'] = 4
