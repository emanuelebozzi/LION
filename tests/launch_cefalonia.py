...
inputs = {}
inputs['tshortp_min_sta'] = 0.5
inputs['tshortp_max_sta'] = 1.5
inputs['tshorts_min_sta'] = 0.5
inputs['tshorts_max_sta'] = 1.5
inputs['tshortp_min_fiber'] = 0.5
inputs['tshortp_max_fiber'] = 1.5
inputs['tshorts_min_fiber'] = 0.5
inputs['tshorts_max_fiber'] = 1.5
inputs['slrat'] = 2
inputs['npr'] = 10
inputs['ntrial'] = 1
