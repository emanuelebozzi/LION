...
inputs = {}
inputs['tshortp_min_sta'] = 1
inputs['tshortp_max_sta'] = 1
inputs['tshorts_min_sta'] = 1.2
inputs['tshorts_max_sta'] = 1.2
inputs['tshortp_min_fiber'] = 0.3
inputs['tshortp_max_fiber'] = 0.3
inputs['tshorts_min_fiber'] = 0.5
inputs['tshorts_max_fiber'] = 0.5
inputs['slrat'] = 3
inputs['npr'] = 10
inputs['ntrial'] = 1
