...
db_path = '/home/emanuele/data/emanuele/loki-das/Traveltimes/friuli'
data_path = '/home/emanuele/data/emanuele/loki-das/friuli/test_lion/event_new'
output_path = '/home/emanuele/data/emanuele/loki-das/friuli/output_event_new'
hdr_filename = 'header_long_friuli.hdr'
geometry_filename_fiber = 'channels.dat'
geometry_filename_stat = 'hybrid_geom.dat'
inputs = {}
inputs['tshortp_min_sta'] = 0.1 #0.1
inputs['tshortp_max_sta'] = 0.5 #0.2
inputs['tshorts_min_sta'] = 0.1 #0.15
inputs['tshorts_max_sta'] = 0.5 #0.25
inputs['tshortp_min_fiber'] = 0.1 #0.1
inputs['tshortp_max_fiber'] = 0.5 #0.3
inputs['tshorts_min_fiber'] = 0.1 #0.15
inputs['tshorts_max_fiber'] = 0.5 #0.35
inputs['slrat'] = 2
inputs['npr'] = 36
inputs['ntrial'] = 5
